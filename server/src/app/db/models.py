...
class Artifact(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="artifacts_ingestion_stage_check",
        ),
    ...
    ingestion_stage: Mapped[str | None] = mapped_column(Text, nullable=True)

    error_message: Mapped[str | None] = mapped_column(Text, nullable=True)

    extracted_text_preview: Mapped[str | None] = mapped_column(Text, nullable=True)

    chunker_name: Mapped[str | None] = mapped_column(Text, nullable=True)

    chunker_params: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, nullable=True
    )
...
class Chunk(Base):
    ...
    __table_args__ = (
        ...
        Index("chunks_artifact_id_chunk_hash_idx", "artifact_id", "chunk_hash"),
    )
